    ...
    <div className="relative w-[100vw] h-[100vh] bg-black ">
      ...
      <div className="absolute top-[15%] left-[33%]  h-[60%] w-[35%] bg-gray-50 opacity-70">
        ...
        <div className="flex flex-col items-start p-4 h-[70%] justify-evenly">
          <h2 className="text-blue-700 text-lg font-bold">Login for <span className="text-green-500 italic">Meal</span><span className="text-black">Master</span></h2>
          ...
          <button className="text-center bg-blue-700 font-semibold text-sm px-9 py-1 rounded-md text-white hover:bg-blue-800">Login</button>
          <Link href="/sign-up">
          <p className="text-blue-600 text-sm">don't have an account? <span className="cursor-pointer underline underline-offset-2 font-medium">Sign up</span></p>
          </Link>
        </div>
      </div>
    </div>
